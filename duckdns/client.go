...
func (c *Client) makeGetRequest(ctx context.Context, path, pathObf string, response *Response) (*http.Response, error) {
...
func (c *Client) newRequest(method, path, pathObf string) (*http.Request, error) {
	url := c.BaseURL + path
